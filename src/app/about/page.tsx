  ...
  return (
    <>
      ...
      <Box pt={20}>
        ...
        <Box
          minH={{ sm: "calc(70vh - 64px)", md: "100vh" }}
          display="flex"
          alignItems="center"
          position="relative"
          overflow="hidden"
                  ...
                  >
                    <Box
                      ...
                      _before={{
                        ...
                        bottom: 0,
                        bgGradient:
                          "linear(to-r, brand.mikadoYellow, brand.gold)",
                        opacity: 0.3,
                        filter: "blur(20px)",
                        zIndex: -1,
                      }}
            ...
            >
              ...
              >
                <VStack align="start" spacing={6}>
                  ...
                  >
                    Founded with a vision to bridge the gap between businesses
                    and technology, Cyberrk Technology has grown into a trusted
                  ...
                  >
                    ...
                    deserves access to world-class digital solutions. Today,
                    we&apos;re proud to have helped numerous clients achieve
                    their goals through innovative technology and strategic
                    thinking.
                  </Text>
                  <Text
                    fontSize={{ base: "md", md: "lg" }}
                  ...
                  >
                    ...
                    expectations. Our commitment to excellence and client
